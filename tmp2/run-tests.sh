...
# Step 3: Start Appium and other services
echo "Step 3: Starting Appium and test services..."
...
# Optional: Keep emulator running for debugging
echo "Emulator is still running. To stop it, run:"
