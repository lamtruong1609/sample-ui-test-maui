...
# Copy the entire MauiApp directory (including resources)
COPY tmp2/BasicAppiumNunitSample/MauiApp /home/app/MauiApp
COPY tmp2/entrypoint_app_builder.sh /home/app/entrypoint.sh

# Build and publish the app
RUN dotnet publish MauiApp/BasicAppiumNunitSample.csproj -f net9.0-android -c Release -o ./publish
